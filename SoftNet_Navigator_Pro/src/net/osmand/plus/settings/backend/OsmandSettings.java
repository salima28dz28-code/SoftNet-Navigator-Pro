...
//	}
	...
	public LatLon getLastKnownMapLocation() {
		// Default center set to Algiers, Algeria (36.7, 3.08) for first-time users
		float lat = settingsAPI.getFloat(globalPreferences, LAST_KNOWN_MAP_LAT, 36.7f);
		float lon = settingsAPI.getFloat(globalPreferences, LAST_KNOWN_MAP_LON, 3.08f);
	...
	public int getLastKnownMapZoom() {
		// Default zoom level 7 shows Algeria fully on first launch
		return settingsAPI.getInt(globalPreferences, LAST_KNOWN_MAP_ZOOM, 7);
	}
